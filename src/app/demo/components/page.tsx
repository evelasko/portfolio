  ...
  return (
    <div className="max-w-6xl mx-auto py-12 px-4 space-y-16">
      ...
      <header className="border-b border-gray-200 pb-8">
        <h1 className={`${TYPOGRAPHY.h1} text-black`}>Component Showcase</h1>
        <p className={`${TYPOGRAPHY.text18} mt-4`}>
          Interactive demonstrations of the BlockQuoteBanner and PortfolioButton components with various configurations.
        </p>
      </header>
