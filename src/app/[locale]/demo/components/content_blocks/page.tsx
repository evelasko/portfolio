        ...
        <div className="max-w-6xl mx-auto py-12 px-4">
          <header>
            ...
            <p className={`${TYPOGRAPHY.text18} mt-4`}>
              Interactive demonstration of content block components with
        ...
        <section>
          <div className="mb-8">
            <h2 className={`${TYPOGRAPHY.h2} text-black mb-4`}>
              ContentHeadingBlock - Photography Portfolio
            </h2>
            <p className={`${TYPOGRAPHY.text16} text-gray-600 mb-6`}>
              Example using the reference data from Oliver Hayes photography
              portfolio with all animation features.
            </p>
...
/>`}
        ...
        <section>
          <div className="mb-8">
            <h2 className={`${TYPOGRAPHY.h2} text-black mb-4`}>
              ContentHeadingBlock - Design Studio
            </h2>
            <p className={`${TYPOGRAPHY.text16} text-gray-600 mb-6`}>
              Alternative example for a design studio project with different
              content.
            </p>
...
/>`}
        ...
        <section>
          <div className="mb-8">
            <h2 className={`${TYPOGRAPHY.h2} text-black mb-4`}>
              ContentHeadingBlock - Tech Project
            </h2>
            <p className={`${TYPOGRAPHY.text16} text-gray-600 mb-6`}>
              Example for a technology project showcasing different types of
              content.
            </p>
...
/>`}
        ...
        <section>
          <div className="mb-8">
            <h2 className={`${TYPOGRAPHY.h2} text-black mb-4`}>
              InfoTextBlock - Achievements Section
            </h2>
            <p className={`${TYPOGRAPHY.text16} text-gray-600 mb-6`}>
              Example using the reference data from the achievements section
              with testimonial and info text layout.
            </p>
...
/>`}
        ...
        <section>
          <div className="mb-8">
            <h2 className={`${TYPOGRAPHY.h2} text-black mb-4`}>
              InfoTextBlock - Project Results
            </h2>
            <p className={`${TYPOGRAPHY.text16} text-gray-600 mb-6`}>
              Alternative example for project results with different content
              structure.
            </p>
...
/>`}
        ...
        <section>
          <div className="mb-8">
            <h2 className={`${TYPOGRAPHY.h2} text-black mb-4`}>
              InfoImageBlock - Approach Section
            </h2>
            <p className={`${TYPOGRAPHY.text16} text-gray-600 mb-6`}>
              Example using the reference data from the approach section with
...
/>`}
        ...
        <section>
          <div className="mb-8">
            <h2 className={`${TYPOGRAPHY.h2} text-black mb-4`}>
              InfoImageBlock - Creative Process
            </h2>
            <p className={`${TYPOGRAPHY.text16} text-gray-600 mb-6`}>
              Alternative example for creative process documentation with
...
/>`}
        ...
        <section>
          <div className="mb-8">
            <h2 className={`${TYPOGRAPHY.h2} text-black mb-4`}>
              InfoSimpleBlock - Process Section
            </h2>
            <p className={`${TYPOGRAPHY.text16} text-gray-600 mb-6`}>
              Example using the reference data from the process section with
...
/>`}
        ...
        <section>
          <div className="mb-8">
            <h2 className={`${TYPOGRAPHY.h2} text-black mb-4`}>
              InfoSimpleBlock - Methodology
            </h2>
            <p className={`${TYPOGRAPHY.text16} text-gray-600 mb-6`}>
              Alternative example for methodology documentation with different
              content structure.
            </p>
...
/>`}
        ...
        <section className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <ul className="text-sm space-y-2 font-mono">
                  ...
                  <li>
                    <strong>date:</strong> string
                  </li>
                  <li>
                    <strong>quote:</strong> string
                  </li>
                  <li>
                    <strong>list_label:</strong> string
                  </li>
                  <li>
                    <strong>list_items:</strong> string[]
                  </li>
                </ul>
              </div>
              <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <ul className="text-sm space-y-2 font-mono">
                  ...
                  <li>
                    <strong>subheading:</strong> string
                  </li>
                  <li>
                    <strong>info_text:</strong> string
                  </li>
                  <li>
                    <strong>quote:</strong> string
                  </li>
                  <li>
                    <strong>quote_author:</strong> string
                  </li>
                </ul>
              </div>
              <div>
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            <h4 className={`${TYPOGRAPHY.h5} mb-4`}>
              ContentHeadingBlock Typography Classes
            </h4>
            <div className="space-y-2 text-sm font-mono">
              <div>
                <strong>overtitle:</strong> mono-24-s m:mono-24-m l:mono-24-l
                (black-40, uppercase)
              </div>
              <div>
                <strong>title:</strong> text-h1-s m:text-h1-m l:text-h1-l
                (black-90)
              </div>
              <div>
                <strong>subtitle:</strong> text-h9-s m:text-h9-m l:text-h9-l
                (black-50)
              </div>
              <div>
                <strong>date:</strong> mono-24-s m:mono-24-m l:mono-24-l
                (black-40, uppercase)
              </div>
              <div>
                <strong>quote:</strong> text-h6-s m:text-h6-m l:text-h6-l
                (black-80)
              </div>
              <div>
                <strong>list_label:</strong> mono-16-s m:mono-16-m l:mono-16-l
                (black-40, uppercase)
              </div>
              <div>
                <strong>list_items:</strong> mono-16-s m:mono-16-m l:mono-16-l
                (black-60, uppercase)
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            <h4 className={`${TYPOGRAPHY.h5} mb-4`}>
              InfoTextBlock Typography Classes
            </h4>
            <div className="space-y-2 text-sm font-mono">
              <div>
                <strong>heading:</strong> mono-20-s m:mono-20-m l:mono-20-l
                (black-90, uppercase)
              </div>
              <div>
                <strong>subheading:</strong> text-20-s m:text-20-m l:text-20-l
                (black-50, italic)
              </div>
              <div>
                <strong>info_text:</strong> text-h9-s m:text-h9-m l:text-h9-l
                (black-80)
              </div>
              <div>
                <strong>quote:</strong> text-h6-s m:text-h6-m l:text-h6-l
                (black-80, font-bold, tracking-[-0.03em])
              </div>
              <div>
                <strong>quote_author:</strong> text-18-s m:text-18-m l:text-18-l
                (black-50)
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <ul className="text-sm space-y-2 font-mono">
                  ...
                  <li>
                    <strong>image_path:</strong> string
                  </li>
                  <li>
                    <strong>image_caption:</strong> string
                  </li>
                  <li>
                    <strong>info_text:</strong> string
                  </li>
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            <h4 className={`${TYPOGRAPHY.h5} mb-4`}>
              InfoImageBlock Typography Classes
            </h4>
            <div className="space-y-2 text-sm font-mono">
              <div>
                <strong>heading:</strong> mono-20-s m:mono-20-m l:mono-20-l
              ...
              <div>
                <strong>image_caption:</strong> text-16-s m:text-16-m
                l:text-16-l (black-50, italic)
              </div>
              <div>
                <strong>info_text:</strong> text-h9-s m:text-h9-m l:text-h9-l
                (black-80)
              ...
              <div>
                <strong>quote:</strong> text-18-s m:text-18-m l:text-18-l
                (black-50, tracking-[-0.03em])
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            <h4 className={`${TYPOGRAPHY.h5} mb-4`}>
              InfoSimpleBlock Typography Classes
            </h4>
            <div className="space-y-2 text-sm font-mono">
              <div>
                <strong>heading:</strong> mono-20-s m:mono-20-m l:mono-20-l
              ...
              <div>
                <strong>subheading:</strong> text-18-s m:text-18-m l:text-18-l
                (black-50)
              </div>
              <div>
                <strong>info_text:</strong> text-h9-s m:text-h9-m l:text-h9-l
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            ...
            <div className="space-y-4">
              <div>
                ...
                <ul className="text-sm space-y-2">
                  <li>
                    <strong>Overtitle (0s):</strong> Per-word fade from bottom,
                    Y offset 30px, spring physics
                  </li>
                  <li>
                    <strong>Title (0.2s delay):</strong> Per-character
                    Y-rotation from 90°, cubic-bezier easing
                  </li>
                  <li>
                    <strong>Subtitle (0.3s delay):</strong> Per-word fade from
                    bottom, spring physics
                  </li>
                  <li>
                    <strong>Date (0.4s delay):</strong> Same animation as
                    subtitle
                  </li>
                  <li>
                    <strong>Quote (0.4s delay):</strong> Same animation as
                    subtitle
                  </li>
                  <li>
                    <strong>Services (0.6s-0.7s):</strong> Staggered fade-up
                    animation
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="text-sm space-y-2">
                  <li>
                    <strong>Spring Duration:</strong> 1 second for natural
                    motion
                  </li>
                  <li>
                    <strong>Character Rotation:</strong> 0.6s with
                    cubic-bezier(0.44, 0, 0.56, 1)
                  </li>
                  <li>
                    <strong>Stagger Delays:</strong> 0.03s between words, 0.02s
                    between characters
                  </li>
                  <li>
                    <strong>Viewport Trigger:</strong> -100px margin for early
                    activation
                  </li>
                </ul>
              </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="bg-gray-900 p-3 rounded font-mono text-sm text-green-400">
                  <div>
                    import ContentHeadingBlock from
                    &apos;@/components/content_blocks/ContentHeadingBlock&apos;;
                  </div>
                  <div>
                    import InfoTextBlock from
                    &apos;@/components/content_blocks/InfoTextBlock&apos;;
                  </div>
                  <div>
                    import InfoImageBlock from
                    &apos;@/components/content_blocks/InfoImageBlock&apos;;
                  </div>
                  <div>
                    import InfoSimpleBlock from
                    &apos;@/components/content_blocks/InfoSimpleBlock&apos;;
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <ul className={`${TYPOGRAPHY.text16} space-y-2`}>
                  <li>
                    • <strong>ContentHeadingBlock Overtitle:</strong> Use short,
                    identifying text (person, company, or category name)
                  </li>
                  <li>
                    • <strong>ContentHeadingBlock Title:</strong> Keep concise
                    for optimal character animation effect
                  </li>
                  <li>
                    • <strong>ContentHeadingBlock Date:</strong> Use consistent
                    date formatting (MONTH YEAR)
                  </li>
                  <li>
                    • <strong>ContentHeadingBlock Quote:</strong> Start with em
                    dash (—) for visual consistency
                  </li>
                  <li>
                    • <strong>InfoTextBlock Heading:</strong> Use section
                    identifiers (ACHIEVEMENTS, RESULTS, etc.)
                  </li>
                  <li>
                    • <strong>InfoTextBlock Subheading:</strong> Use as
                    testimonial quote with quotation marks
                  </li>
                  <li>
                    • <strong>InfoImageBlock Heading:</strong> Use process
                    identifiers (APPROACH, PROCESS, METHOD, etc.)
                  </li>
                  <li>
                    • <strong>InfoImageBlock Images:</strong> Use high-quality
                    images with 4:3 aspect ratio for best display
                  </li>
                  <li>
                    • <strong>InfoSimpleBlock Heading:</strong> Use methodology
                    identifiers (PROCESS, METHODOLOGY, STRATEGY, etc.)
                  </li>
                  <li>
                    • <strong>InfoSimpleBlock Subheading:</strong> Provide
                    overview or approach summary in left column
                  </li>
                  <li>
                    • <strong>Content Balance:</strong> Keep left and right
                    column content proportionally balanced
                  </li>
                  <li>
                    • <strong>Text Hierarchy:</strong> Use proper typography
                    contrast between headings and body text
                  </li>
                  <li>
                    • <strong>Responsive Layout:</strong> All components adapt
                    gracefully to all screen sizes
                  </li>
                  <li>
                    • <strong>Animation Sequence:</strong> Consider scroll
                    position for optimal animation viewing
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className={`${TYPOGRAPHY.text16} space-y-2`}>
                  <li>
                    • <strong>Animation Complexity:</strong> High due to
                    per-character/word animations
                  </li>
                  <li>
                    • <strong>Mobile Optimization:</strong> Consider reduced
                    animations on smaller screens
                  </li>
                  <li>
                    • <strong>Text Length:</strong> Longer titles may impact
                    animation performance
                  </li>
                  <li>
                    • <strong>Viewport Settings:</strong> Animations trigger
                    once when entering viewport
                  </li>
                </ul>
              </div>
            </div>
