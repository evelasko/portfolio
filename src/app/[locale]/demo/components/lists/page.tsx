    ...
    <div className="max-w-6xl mx-auto py-12 px-4 space-y-16">
      ...
      <header className="border-b border-gray-200 pb-8">
        ...
        <p className={`${TYPOGRAPHY.text18} mt-4`}>
          Interactive demonstrations of the list components with various
          configurations.
        </p>
      </header>
  ...
  />
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            ...
            <div className="space-y-3 text-sm">
              <div>
                <strong>Container:</strong> Full width with CSS Grid layout and
                top border
              </div>
              <div>
                <strong>Large Screens:</strong> 2-column grid (content | image)
              </div>
              <div>
                <strong>Mobile/Tablet:</strong> 1-column grid (image on top,
                content below)
              </div>
              <div>
                <strong>Heights:</strong> 600px (S) → 300px (M) → 300px (L)
              </div>
              <div>
                <strong>Image Height:</strong> Fixed 200px on small, full height
                on medium/large
              </div>
              <div>
                <strong>Content Padding:</strong> 24px (S) → 32px (M) → 48px (L)
              </div>
              <div>
                <strong>Content Spacing:</strong> 24px (S) → 32px (L) between
                label/title/description
              </div>
              <div>
                <strong>Borders:</strong> 1px top border (black-10), bottom
                border on list container
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            ...
            <div className="space-y-2 text-sm">
              <div>
                <strong>Small Screens:</strong> Image on top (200px), content
                below, 600px total height
              </div>
              <div>
                <strong>Medium Screens:</strong> Side-by-side layout, 300px
                height
              </div>
              <div>
                <strong>Large Screens:</strong> Side-by-side layout, content
                left, image right, 300px height
              </div>
              <div>
                <strong>Content Alignment:</strong> Vertically centered in
                content area
              </div>
              <div>
                <strong>Image Display:</strong> Full coverage with object-cover
              </div>
              <div>
                <strong>Content Spacing:</strong> Label has more space to title
                (24px/32px) than title to description
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            ...
            <div className="space-y-2 text-sm font-mono">
              <div>
                <strong>label:</strong> mono-16-s m:mono-16-m l:mono-16-l
                (black-50, uppercase)
              </div>
              <div>
                <strong>title:</strong> text-h7-s m:text-h7-m l:text-h7-l
                (black-90)
              </div>
              <div>
                <strong>description:</strong> text-16-s m:text-16-m l:text-16-l
                (black-50)
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            ...
            <div className="space-y-2 text-sm">
              <div>
                <strong>List Layout:</strong> Stack items with no spacing
                (space-y-0) for continuous design
              </div>
              <div>
                <strong>List Borders:</strong> Add border-b border-black-10 to
                list container for bottom border
              </div>
              <div>
                <strong>Container:</strong> Use full width containers, not grid
                systems
              </div>
              <div>
                <strong>Content Order:</strong> Built-in responsive ordering (no
                manual configuration needed)
              </div>
              <div>
                <strong>Image Sizing:</strong> 200px height on mobile, full
                height on larger screens
              </div>
              <div>
                <strong>Content Spacing:</strong> Increased space between label
                and title for better hierarchy
              </div>
              <div>
                <strong>Link Coverage:</strong> Entire item area is clickable
              </div>
              <div>
                <strong>Accessibility:</strong> Semantic HTML with proper
                heading hierarchy
              </div>
            </div>
          </div>
...
/>`}
  ...
  />
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            ...
            <div className="space-y-2 text-sm font-mono">
              <div>
                <strong>message:</strong> text-h9-s m:text-h9-m l:text-h9-l
                (black-70)
              </div>
              <div>
                <strong>name:</strong> mono-18-s m:mono-18-m l:mono-18-l
                (black-90, uppercase)
              </div>
              <div>
                <strong>title:</strong> mono-16-s m:mono-16-m l:mono-16-l
                (black-50, uppercase)
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            ...
            <div className="space-y-2 text-sm">
              <div>
                <strong>Card Design:</strong> White background with subtle
                shadow and border
              </div>
              <div>
                <strong>Message Layout:</strong> Testimonial text at top with
                generous bottom margin
              </div>
              <div>
                <strong>Author Layout:</strong> Horizontal flex with avatar and
                text information
              </div>
              <div>
                <strong>Avatar Size:</strong> Fixed 42px circular image
              </div>
              <div>
                <strong>Responsive Padding:</strong> 32px (S) → 40px (M) → 48px
                (L)
              </div>
              <div>
                <strong>Grid Support:</strong> Works well in 1, 2, or 3 column
                layouts
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            ...
            <div className="space-y-2 text-sm">
              <div>
                <strong>Typography:</strong> Responsive text sizes across all
                breakpoints
              </div>
              <div>
                <strong>Spacing:</strong> Increased padding on larger screens
              </div>
              <div>
                <strong>Avatar:</strong> Fixed size across all breakpoints
              </div>
              <div>
                <strong>Grid Layout:</strong> Stacks to single column on mobile
              </div>
              <div>
                <strong>Message Text:</strong> Line height adjusts for
                readability
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            ...
            <div className="space-y-2 text-sm">
              <div>
                <strong>Message Length:</strong> Keep testimonials concise but
                meaningful (1-3 sentences)
              </div>
              <div>
                <strong>Avatar Images:</strong> Use high-quality, professional
                headshots
              </div>
              <div>
                <strong>Name Format:</strong> Use full names in proper case
                (will be uppercased)
              </div>
              <div>
                <strong>Title Format:</strong> Include role and company for
                credibility
              </div>
              <div>
                <strong>Grid Spacing:</strong> Use gap-6 or gap-8 for optimal
                visual separation
              </div>
              <div>
                <strong>Container Width:</strong> Max-width constraints work
...
/>`}
          ...
          <div className="bg-blue-50 p-6 rounded-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <ul className="text-sm space-y-1 font-mono">
                  <li>
                    <strong>itemNumber:</strong> number
                  </li>
                  <li>
                    <strong>title:</strong> string
                  </li>
              ...
              <div>
                ...
                <ul className="text-sm space-y-1">
                  ...
                  <li>
                    • Proportional two-column layout (70/30) on large screens,
                    single column on smaller
                  </li>
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            ...
            <div className="space-y-3 text-sm">
              <div>
                <strong>Entry Animation:</strong> Fade in from bottom with 170px
                Y offset
              </div>
              <div>
                <strong>Blur Effect:</strong> Starts with 10px blur, animates to
                0px
              </div>
              <div>
                <strong>Spring Physics:</strong> Stiffness: 300, Damping: 60,
                Mass: 1
              </div>
              <div>
                <strong>Duration:</strong> 0.8s for smooth, professional feel
              </div>
              <div>
                <strong>Viewport Trigger:</strong> Animates once when entering
                viewport
              </div>
              <div>
                <strong>Trigger Margin:</strong> -100px for early activation
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            ...
            <div className="space-y-2 text-sm font-mono">
              <div>
                <strong>itemNumber:</strong> mono-16-s m:mono-16-m l:mono-16-l
                (black-40)
              </div>
              <div>
              ...
              <div>
                <strong>skills:</strong> mono-16-s m:mono-16-m l:mono-16-l
                (black-90, uppercase)
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            ...
            <div className="space-y-2 text-sm">
              <div>
                <strong>Grid Layout:</strong> Single column on S&M, 70/30 split
                (left/right) on L
              </div>
              <div>
                <strong>Column Gap:</strong> 24px (6) gap on S&M, 32px (8) gap
                on L screens
              </div>
              <div>
                <strong>Content Spacing:</strong> 24px (6) spacing on S&M, 32px
                (8) on L screens
              </div>
              <div>
                <strong>Typography:</strong> Responsive text sizes across all
              ...
              <div>
                <strong>Skills List:</strong> Vertical stack with 8px spacing
                between items
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            ...
            <div className="space-y-2 text-sm">
              <div>
                <strong>Item Number:</strong> Zero-padded format (01, 02, 03...)
              </div>
              <div>
                <strong>Skills List:</strong> Unordered list with 14px bottom
                padding
              </div>
              <div>
                <strong>List Border:</strong> 1px bottom border with black-10
                color
              </div>
              <div>
                <strong>Skills Typography:</strong> Uppercase mono-16 font
                styling
              </div>
              <div>
                <strong>Color Hierarchy:</strong> Black-90 → Black-50 → Black-40
              </div>
              <div>
                <strong>Typography Weights:</strong> Bold titles, regular body
                text
              </div>
            </div>
          </div>
        ...
        <div className="bg-green-50 p-6 rounded-lg space-y-6">
          <div>
            ...
            <div className="bg-gray-900 p-4 rounded font-mono text-sm text-green-400">
              <div>
                ...
                &apos;@/components/list_items/ProjectItem&apos;;
              </div>
              <div>
                import SkillsItem from
                &apos;@/components/list_items/SkillsItem&apos;;
              </div>
              <div>
                import TestimonialItem from
                &apos;@/components/list_items/TestimonialItem&apos;;
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className={`${TYPOGRAPHY.text16} space-y-2`}>
              <li>
                • <strong>ProjectItem Images:</strong> Use high-quality images
                that work well cropped
              </li>
              <li>
                • <strong>ProjectItem Content:</strong> Keep labels short,
                titles compelling, descriptions concise
              </li>
              <li>
                • <strong>ProjectItem Layout:</strong> Use as full-width list
                items, not in grid systems
              </li>
              <li>
                • <strong>ProjectItem Links:</strong> Ensure all href props
                point to valid project pages
              </li>
              <li>
                • <strong>ProjectItem Spacing:</strong> Stack with space-y-0 for
                continuous visual flow
              </li>
              <li>
                • <strong>ProjectItem Borders:</strong> Each item has top
                border, add bottom border to list container
              </li>
              <li>
                • <strong>TestimonialItem Content:</strong> Keep messages
                concise, use professional headshots
              </li>
              <li>
                • <strong>TestimonialItem Layout:</strong> Works well in 1-3
                column grids with proper spacing
              </li>
              <li>
                • <strong>TestimonialItem Credibility:</strong> Include full
                names and job titles for authenticity
              </li>
              <li>
                • <strong>SkillsItem Numbers:</strong> Use sequential numbering
                starting from 1
              </li>
              <li>
                • <strong>SkillsItem Titles:</strong> Keep titles concise and
                descriptive (2-4 words)
              </li>
              <li>
                • <strong>SkillsItem Descriptions:</strong> Write clear,
                benefit-focused descriptions (1-3 sentences)
              </li>
              <li>
                • <strong>Skills Arrays:</strong> List 3-8 relevant skills for
                optimal two-column layout
              </li>
              <li>
                • <strong>Skills Naming:</strong> Use consistent, professional
                skill names (will be uppercase)
              </li>
              <li>
                • <strong>List Spacing:</strong> Use space-y-16 l:space-y-20
                between SkillsItems
              </li>
              <li>
                • <strong>Container Width:</strong> Use max-w-4xl or larger for
                SkillsItem two-column layout
              </li>
              <li>
                • <strong>Content Hierarchy:</strong> Maintain consistent
                formatting across items
              </li>
              <li>
                • <strong>Animation:</strong> ProjectItem and SkillsItem include
                scroll-triggered animations
              </li>
              <li>
                • <strong>Accessibility:</strong> Semantic HTML ensures screen
          ...
          <div>
            ...
            <ul className={`${TYPOGRAPHY.text16} space-y-2`}>
              <li>
                • <strong>ProjectItem Layout:</strong> Full-width list items
                with two-column structure
              </li>
              <li>
                • <strong>SkillsItem Layout:</strong> 70% content, 30% skills on
                large screens
              </li>
              <li>
                • <strong>TestimonialItem Layout:</strong> Card-based design
                suitable for grid layouts
              </li>
              <li>
                • <strong>Responsive Design:</strong> All components stack
                appropriately on mobile
              </li>
              <li>
                • <strong>Vertical Spacing:</strong> ProjectItem uses space-y-0,
                others use generous spacing
              </li>
              <li>
                • <strong>Content Alignment:</strong> Left-align content for
                optimal readability
              </li>
              <li>
                • <strong>Section Context:</strong> Use components in
                appropriate page sections
              </li>
            </ul>
          </div>
        </div>
