      ...
      >
        ...
        <header className="border-b border-gray-200 pb-8">
          ...
          <p className={`${TYPOGRAPHY.text18} mt-4`}>
            A clean, minimal hero component with fullscreen background image and
            ...
            >
              <div className="bg-gray-100 p-4 rounded-lg text-center">
                <p className="text-gray-600">
                  The MinimalHero component above demonstrates the full
                  implementation. It features a fullscreen layout with smooth
                  text animations and responsive design.
                </p>
              </div>
            </CodeExample>
...
/>`}
            >
              <div className="bg-blue-50 p-4 rounded-lg">
                <p className="text-blue-800">
                  ...
                  component with different content and background images.
                </p>
              </div>
            </CodeExample>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div>
                  ...
                  <ul className="text-sm space-y-2 font-mono">
                    ...
                    <li>
                      <strong>image:</strong> string - Fullscreen background
                      image URL
                    </li>
                    <li>
            ...
            <div className="bg-yellow-50 p-6 rounded-lg">
              ...
              <div className="space-y-3 text-sm">
                ...
                <div>
                  <strong>Timing Sequence:</strong> Title (0.2s) → Subtitle
                  (1.2s) → Arrow (2.4s)
                </div>
                <div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <div className="space-y-2 text-sm">
                <div>
                  <strong>Desktop (L):</strong> 80px horizontal padding, full
                  content width
                </div>
                <div>
                ...
                <div>
                  <strong>Mobile (S):</strong> 16px horizontal padding,
                ...
                <div>
                  <strong>Content:</strong> Centered vertically, left-aligned
                  text
                </div>
                <div>
            ...
            <div className="bg-red-50 p-6 rounded-lg">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div>
                  <strong>Responsive Images:</strong> Full viewport sizing with
                  appropriate object-fit
                </div>
                <div>
                  <strong>Text Contrast:</strong> Semi-transparent dark overlay
                  ensures readability
                </div>
              </div>
            </div>
          ...
          <div className="bg-green-50 p-6 rounded-lg space-y-6">
            <div>
              ...
              <div className="bg-gray-900 p-4 rounded font-mono text-sm text-green-400">
                <div>
                  import MinimalHero from
                  &apos;@/components/heroes/MinimalHero&apos;;
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <ul className={`${TYPOGRAPHY.text16} space-y-2`}>
                ...
                <li>
                  • <strong>Image Selection:</strong> Choose images with good
                  contrast areas for text overlay
                </li>
                <li>
                  • <strong>Link Target:</strong> Ensure arrow link points to
                  next section or relevant page
                </li>
                <li>
                ...
                <li>
                  • <strong>Performance:</strong> Optimize images before
                  implementation
                </li>
                <li>
                ...
                <li>
                  • <strong>Animation Timing:</strong> Default timing works
                  well, avoid customization unless necessary
                </li>
                <li>
                  • <strong>Testing:</strong> Test on various devices to ensure
