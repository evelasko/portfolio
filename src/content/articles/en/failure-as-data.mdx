...
*Want to build resilience and learn from failures? [CENIE community normalizes experimentation](https://cenie.io) and treats failures as learning opportunities.*
