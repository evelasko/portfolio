...
description:
  The counterintuitive discovery that doing less, more intentionally, produces
  better results than constant frantic activity.
draft: false
featured: true
...
Craft means knowing _why_ you're making specific decisions, not just making them quickly.
...
Craft requires understanding _why_, not just _how_. This builds transferable mastery.
...
- No time to understand _why_ things work
...
_Interested in methodologies for intentional creative work? [CENIE Editorial shares frameworks](https://cenie.io) for craft-driven creation._
