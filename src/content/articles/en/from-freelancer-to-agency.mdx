...
description:
  The real story of transitioning from solo freelancer to running an agency—including
  the mistakes, pivots, and lessons learned along the way.
draft: false
featured: false
...
_Thinking about scaling beyond solo work? [CENIE Academy offers courses](https://cenie.io) on building sustainable creative businesses._
