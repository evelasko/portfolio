...
description: A menudo pensamos que la creatividad florece en la libertad total. La verdad es que la estructura no es el enemigo de la creatividad; es su mejor aliado. Cómo construir tus propios sistemas libera tu mente para el trabajo que realmente importa.
draft: false
featured: false
...
- Un músico de jazz improvisa con una libertad asombrosa _dentro_ de las restricciones de la armonía y el ritmo.
- Un coreógrafo crea movimientos expresivos _dentro_ de las limitaciones de la gravedad y la anatomía humana.
- Un pintor compone una obra maestra _dentro_ de los principios de la teoría del color.
...
Tu sistema no tiene por qué ser perfecto. Solo tiene que ser _tuyo_. Debe reflejar tus gustos, tus flujos de trabajo y tu filosofía. Es un organismo vivo que evoluciona contigo y con tu práctica.
