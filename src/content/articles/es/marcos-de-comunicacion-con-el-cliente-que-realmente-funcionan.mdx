...
description:
  La mayoría de los proyectos no fracasan por razones técnicas, sino por una mala comunicación. Los sistemas que uso para alinear expectativas, gestionar el feedback y construir relaciones de confianza con los clientes.
draft: false
featured: false
...
-   **El `Qué` (Alcance):** Una lista con viñetas de lo que está *incluido* y, crucialmente, lo que está *excluido*. "Incluye 5 páginas; excluye un blog y e-commerce".
