  ...
  return {
    ...
    h2: ({ children, ...props }) => (
      <h2
        className={clsx(
          TYPOGRAPHY.h3,
          "font-extrabold leading-[1em] mt-18 mb-8"
        )}
        {...props}
      >
        {children}
    ...
    h4: ({ children, ...props }) => (
      <h4 className={clsx(TYPOGRAPHY.h6, "mt-6 mb-3")} {...props}>
        {children}
      </h4>
    ),
    h5: ({ children, ...props }) => (
      <h5 className={clsx(TYPOGRAPHY.h7, "mt-6 mb-3")} {...props}>
        {children}
      </h5>
    ),
    h6: ({ children, ...props }) => (
      <h6 className={clsx(TYPOGRAPHY.h8, "mt-6 mb-3")} {...props}>
        {children}
      </h6>
    ),
